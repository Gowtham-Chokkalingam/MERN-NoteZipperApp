...
export const userLoginReducer = (state = {}, action) => {
  switch (action.type) {
    case USER_LOGIN_REQUEST:
      return {loginStatus:false,  loading: true ,error:false};

    case USER_LOGIN_SUCCESS:
      return { loading: false,loginStatus:true, error:false,userInfo: action.payload };

    case USER_LOGIN_FAIL:
      return {loginStatus:false,  loading: false, error: action.payload };
